...
# Load dataset
# -----------------------------
df = pd.read_csv("gs://learning-feb26-dev/section11_custom-training-pre-built-container/input-file/sentiment-analysis-input-10000.csv")   
...
# -----------------------------
model.save("gs://learning-feb26-dev/section11_custom-training-pre-built-container/model-output-dir/sentiment_model")  # includes vectorizer + LSTM
